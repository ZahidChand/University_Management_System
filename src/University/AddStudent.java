...
public class AddStudent implements ActionListener
{
    ...
    public AddStudent()
    {
       ...
       // id2.setForeground(Color.BLACK);
        ...
        String branch[] ={"Computer Science","Electronic","Electricals","Mechanical","Civils"};
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()== b)
        {
            ...
            String sql = "Insert into student values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"')";
