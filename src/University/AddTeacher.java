...
JFrame f;
    ...
    public AddTeacher()
    {
       ...
       // id2.setForeground(Color.BLACK);
        ...
        String educ[] ={"B.Tech","BBA","BCA","Bsc","Msc","MBA","MCA","BA","Bcom"};
        
        c1 = new JComboBox(educ);
        ...
        String dept[] ={"Computer Science","Electronic","Electricals","Mechanical","Civils"};
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()== b)
        {
            ...
            String sql = "Insert into teacher values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"')";
