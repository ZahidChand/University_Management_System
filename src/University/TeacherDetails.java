...
public class TeacherDetails extends JFrame implements ActionListener
{
    ...
    String x[] = {"Name","Father Name","Age","Date Of Birth","Address","Phone","Email","Class X","Class XII","Aadhar No","Employee ID ","Course","Department"};
...
setTitle("Teacher Details");
    ...
    try
    {
        ...
        while(rst.next())
        {
            ...
            y[i][j++] = rst.getString("emp_id");
            y[i][j++] = rst.getString("course");
            y[i][j++] = rst.getString("dept");
            i++;
            j=0; 
        }
        t1 = new JTable(y,x);
...
public void actionPerformed(ActionEvent ae)
{
    try
    {
        ...
        if(ae.getSource()==b1)
        {
            ...
            { 
            String k = t2.getText();
            String sql = "delete from teacher where emp_id = '"+k+"'";
