...
public class UpdateStudent implements ActionListener
{
    ...
    UpdateStudent()
    {
        ...
        JLabel l1 = new JLabel("Enter Roll No To Update Student Details");
...
public void actionPerformed(ActionEvent ae)
{
    if(ae.getSource()==b)
    {
        try
        {
            ...
            String sql = "update student set name = '"+t1.getText()+"',father_name='"+t2.getText()+"',age ='"+t3.getText()+"',dob ='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',adharno='"+t10.getText()+"',course='"+t13.getText()+"',branch='"+t14.getText()+"' where roll_no='"+t12.getText()+"'";
    ...
    if(ae.getSource()==b2)
    {
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ums", "root", "");
            Statement st = con.createStatement();
            String sql = "select * from student where roll_no = '"+t12.getText()+"'";
